...
import com.github.nitrico.lastadapterx.ItemType;
import com.github.nitrico.lastadapterx.LastAdapterX;
import com.github.nitrico.lastadapterx.LayoutHandler;
import com.github.nitrico.lastadapterx.BaseType;
import com.github.nitrico.lastadapterx.TypeHandler;
import com.github.nitrico.lastadapterx.Holder;
...
public class JavaListFragment extends ListFragment {
    ...
    private void setMapAdapterWithListeners(List<Object> items, boolean stableIds) {
        new LastAdapterX(items, BR.item, stableIds)
    ...
    private void setLayoutHandlerAdapter(List<Object> items, boolean stableIds) {
        new LastAdapterX(items, BR.item, stableIds).handler(new LayoutHandler() {
            @Override
    ...
    private void setTypeHandlerAdapter(List<Object> items, boolean stableIds) {
        new LastAdapterX(items, BR.item, stableIds).handler(new TypeHandler() {
            @Override
